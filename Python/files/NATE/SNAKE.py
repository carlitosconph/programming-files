...
while not end_game:
  ...
  #! Generate rendom objects on the map
  ...
  print('+' + '-' * MAP_WIDTH * 2 + '+')
  print(f'\t\tManzanas comidas: {tail_lengh}')
  ...
  if new_position:
    if obstacle_definition[new_position[POS_Y]][new_position[POS_X]] != '#':
      ...
      tail = tail[:tail_lengh]
      my_position = new_position
if died:
  print(f'\nHas muerto!, tu puntuacion es de {tail_lengh}')